...
function Projects() {
  const text = `Featured projects crafted with passion
  driven by a desire to learn and experiment`;
  ...
  useGSAP(() => {
    // x axis, quickTo is more performant than to, it needs to be fast to follow the mouse
